...
{
    {MAPSEC_PACIFIDLOG_TOWN,       FLAG_LANDMARK_SKY_PILLAR},
    {MAPSEC_SOOTOPOLIS_CITY,  FLAG_LANDMARK_SEAFLOOR_CAVERN},
    {MAPSEC_ALTERING_CAVE,    FLAG_LANDMARK_ALTERING_CAVE},
    {MAPSEC_MIRAGE_TOWER,     FLAG_LANDMARK_MIRAGE_TOWER},
    {MAPSEC_LAVARIDGE_TOWN, FLAG_LANDMARK_DESERT_UNDERPASS},
