...
static void CreateSeviiSSTidalMultichoice(void)
{
    ...
    else
    {
        ...
        for (selectionCount = 0, i = 0; i < SSTIDAL_SELECTION_COUNT_S; i++)
        {
            ...
            {
                AddTextPrinterParameterized(windowId, FONT_NORMAL, sSeviiSSTidalDestinations[sSeviiSSTidalSelections[i]], 8, selectionCount * 16 + 1, TEXT_SKIP_DRAW, NULL);
                selectionCount++;
            }
        }
...
static void CreateLilycoveSSTidalSeviiMultichoice(void)
{
    ...
    for (u8 i = 0; i < SSTIDAL_SELECTION_SEVII_COUNT; i++)
    {
...
static void CreateSevii1SSTidalMultichoice(void)
{
    ...
    for (u8 i = 0; i < SSTIDAL_SELECTION_SEVII_COUNT_S; i++)
    {
