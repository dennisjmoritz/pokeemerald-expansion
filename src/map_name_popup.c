...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT] =
{
    ...
    [MAPSEC_BLACKTHORN_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ECRUTEAK_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_GOLDENROD_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SNOWPOINT_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_VIOLET_CITY] = MAPPOPUP_THEME_WOOD,
