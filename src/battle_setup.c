...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE, TRAINER_ROSE, TRAINER_ROSE, TRAINER_ROSE, TRAINER_ROSE, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES, TRAINER_ANDRES, TRAINER_ANDRES, TRAINER_ANDRES, TRAINER_ANDRES, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY, TRAINER_DUSTY, TRAINER_DUSTY, TRAINER_DUSTY, TRAINER_DUSTY, MAP_ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA, TRAINER_LOLA, TRAINER_LOLA, TRAINER_LOLA, TRAINER_LOLA, MAP_ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY, TRAINER_RICKY, TRAINER_RICKY, TRAINER_RICKY, TRAINER_RICKY, MAP_ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY, TRAINER_LILA_AND_ROY, TRAINER_LILA_AND_ROY, TRAINER_LILA_AND_ROY, TRAINER_LILA_AND_ROY, MAP_ROUTE124),
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN, TRAINER_CRISTIN, TRAINER_CRISTIN, TRAINER_CRISTIN, TRAINER_CRISTIN, MAP_ROUTE121),
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE, TRAINER_BROOKE, TRAINER_BROOKE, TRAINER_BROOKE, TRAINER_BROOKE, MAP_ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON, TRAINER_WILTON, TRAINER_WILTON, TRAINER_WILTON, TRAINER_WILTON, MAP_ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE, TRAINER_VALERIE, TRAINER_VALERIE, TRAINER_VALERIE, TRAINER_VALERIE, MAP_MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY, TRAINER_CINDY, TRAINER_CINDY, TRAINER_CINDY, TRAINER_CINDY, MAP_ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA, TRAINER_THALIA, TRAINER_THALIA, TRAINER_THALIA, TRAINER_THALIA, MAP_ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA, TRAINER_JESSICA, TRAINER_JESSICA, TRAINER_JESSICA, TRAINER_JESSICA, MAP_ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON, TRAINER_WINSTON, TRAINER_WINSTON, TRAINER_WINSTON, TRAINER_WINSTON, MAP_ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE, TRAINER_STEVE, TRAINER_STEVE, TRAINER_STEVE, TRAINER_STEVE, MAP_ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_TONY, TRAINER_TONY, TRAINER_TONY, TRAINER_TONY, TRAINER_TONY, MAP_ROUTE107),
    [REMATCH_NOB] = REMATCH(TRAINER_NOB, TRAINER_NOB, TRAINER_NOB, TRAINER_NOB, TRAINER_NOB, MAP_ROUTE115),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI, TRAINER_KOJI, TRAINER_KOJI, TRAINER_KOJI, TRAINER_KOJI, MAP_ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO, TRAINER_FERNANDO, TRAINER_FERNANDO, TRAINER_FERNANDO, TRAINER_FERNANDO, MAP_ROUTE123),
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON, TRAINER_DALTON, TRAINER_DALTON, TRAINER_DALTON, TRAINER_DALTON, MAP_ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE, TRAINER_BERNIE, TRAINER_BERNIE, TRAINER_BERNIE, TRAINER_BERNIE, MAP_ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN, TRAINER_ETHAN, TRAINER_ETHAN, TRAINER_ETHAN, TRAINER_ETHAN, MAP_JAGGED_PASS),
    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY, TRAINER_JOHN_AND_JAY, TRAINER_JOHN_AND_JAY, TRAINER_JOHN_AND_JAY, TRAINER_JOHN_AND_JAY, MAP_METEOR_FALLS_1F_2R),
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY, TRAINER_JEFFREY, TRAINER_JEFFREY, TRAINER_JEFFREY, TRAINER_JEFFREY, MAP_ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON, TRAINER_CAMERON, TRAINER_CAMERON, TRAINER_CAMERON, TRAINER_CAMERON, MAP_ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_JACKI, TRAINER_JACKI, TRAINER_JACKI, TRAINER_JACKI, TRAINER_JACKI, MAP_ROUTE123),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER, TRAINER_WALTER, TRAINER_WALTER, TRAINER_WALTER, TRAINER_WALTER, MAP_ROUTE121),
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, MAP_ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY, TRAINER_JERRY, TRAINER_JERRY, TRAINER_JERRY, TRAINER_JERRY, MAP_ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_ANNA_AND_MEG, TRAINER_ANNA_AND_MEG, TRAINER_ANNA_AND_MEG, TRAINER_ANNA_AND_MEG, TRAINER_ANNA_AND_MEG, MAP_ROUTE117),
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL, TRAINER_ISABEL, TRAINER_ISABEL, TRAINER_ISABEL, TRAINER_ISABEL, MAP_ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL, TRAINER_MIGUEL, TRAINER_MIGUEL, TRAINER_MIGUEL, TRAINER_MIGUEL, MAP_ROUTE103),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY, TRAINER_TIMOTHY, TRAINER_TIMOTHY, TRAINER_TIMOTHY, TRAINER_TIMOTHY, MAP_ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY, TRAINER_SHELBY, TRAINER_SHELBY, TRAINER_SHELBY, TRAINER_SHELBY, MAP_MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN, TRAINER_CALVIN, TRAINER_CALVIN, TRAINER_CALVIN, TRAINER_CALVIN, MAP_ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT, TRAINER_ELLIOT, TRAINER_ELLIOT, TRAINER_ELLIOT, TRAINER_ELLIOT, MAP_ROUTE106),
    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH, TRAINER_ISAIAH, TRAINER_ISAIAH, TRAINER_ISAIAH, TRAINER_ISAIAH, MAP_ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA, TRAINER_MARIA, TRAINER_MARIA, TRAINER_MARIA, TRAINER_MARIA, MAP_ROUTE117),
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL, TRAINER_ABIGAIL, TRAINER_ABIGAIL, TRAINER_ABIGAIL, TRAINER_ABIGAIL, MAP_ROUTE110),
    [REMATCH_DYLAN] = REMATCH(TRAINER_DYLAN, TRAINER_DYLAN, TRAINER_DYLAN, TRAINER_DYLAN, TRAINER_DYLAN, MAP_ROUTE117),
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN, TRAINER_KATELYN, TRAINER_KATELYN, TRAINER_KATELYN, TRAINER_KATELYN, MAP_ROUTE128),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN, TRAINER_BENJAMIN, TRAINER_BENJAMIN, TRAINER_BENJAMIN, TRAINER_BENJAMIN, MAP_ROUTE110),
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO, TRAINER_PABLO, TRAINER_PABLO, TRAINER_PABLO, TRAINER_PABLO, MAP_ROUTE126),
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS, TRAINER_NICOLAS, TRAINER_NICOLAS, TRAINER_NICOLAS, TRAINER_NICOLAS, MAP_METEOR_FALLS_1F_2R),
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT, TRAINER_ROBERT, TRAINER_ROBERT, TRAINER_ROBERT, TRAINER_ROBERT, MAP_ROUTE120),
    [REMATCH_LAO] = REMATCH(TRAINER_LAO, TRAINER_LAO, TRAINER_LAO, TRAINER_LAO, TRAINER_LAO, MAP_ROUTE113),
    [REMATCH_CYNDY] = REMATCH(TRAINER_CYNDY, TRAINER_CYNDY, TRAINER_CYNDY, TRAINER_CYNDY, TRAINER_CYNDY, MAP_ROUTE115),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE, TRAINER_MADELINE, TRAINER_MADELINE, TRAINER_MADELINE, TRAINER_MADELINE, MAP_ROUTE113),
    [REMATCH_JENNY] = REMATCH(TRAINER_JENNY, TRAINER_JENNY, TRAINER_JENNY, TRAINER_JENNY, TRAINER_JENNY, MAP_ROUTE124),
    [REMATCH_DIANA] = REMATCH(TRAINER_DIANA, TRAINER_DIANA, TRAINER_DIANA, TRAINER_DIANA, TRAINER_DIANA, MAP_JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV, TRAINER_AMY_AND_LIV, TRAINER_AMY_AND_LIV, TRAINER_AMY_AND_LIV, TRAINER_AMY_AND_LIV, MAP_ROUTE103),
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST, TRAINER_ERNEST, TRAINER_ERNEST, TRAINER_ERNEST, TRAINER_ERNEST, MAP_ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_CORY, TRAINER_CORY, TRAINER_CORY, TRAINER_CORY, TRAINER_CORY, MAP_ROUTE108),
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN, TRAINER_EDWIN, TRAINER_EDWIN, TRAINER_EDWIN, TRAINER_EDWIN, MAP_ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA, TRAINER_LYDIA, TRAINER_LYDIA, TRAINER_LYDIA, TRAINER_LYDIA, MAP_ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC, TRAINER_ISAAC, TRAINER_ISAAC, TRAINER_ISAAC, TRAINER_ISAAC, MAP_ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE, TRAINER_GABRIELLE, TRAINER_GABRIELLE, TRAINER_GABRIELLE, TRAINER_GABRIELLE, MAP_MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE, TRAINER_CATHERINE, TRAINER_CATHERINE, TRAINER_CATHERINE, TRAINER_CATHERINE, MAP_ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON, TRAINER_JACKSON, TRAINER_JACKSON, TRAINER_JACKSON, TRAINER_JACKSON, MAP_ROUTE119),
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY, TRAINER_HALEY, TRAINER_HALEY, TRAINER_HALEY, TRAINER_HALEY, MAP_ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES, TRAINER_JAMES, TRAINER_JAMES, TRAINER_JAMES, TRAINER_JAMES, MAP_PETALBURG_WOODS),
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT, TRAINER_TRENT, TRAINER_TRENT, TRAINER_TRENT, TRAINER_TRENT, MAP_ROUTE112),
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER, TRAINER_SAWYER, TRAINER_SAWYER, TRAINER_SAWYER, TRAINER_SAWYER, MAP_MT_CHIMNEY),
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN, TRAINER_KIRA_AND_DAN, TRAINER_KIRA_AND_DAN, TRAINER_KIRA_AND_DAN, TRAINER_KIRA_AND_DAN, MAP_ABANDONED_SHIP_ROOMS2_1F),
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR, TRAINER_WALLY_VR, TRAINER_WALLY_VR, TRAINER_WALLY_VR, TRAINER_WALLY_VR, MAP_VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE, TRAINER_ROXANNE, TRAINER_ROXANNE, TRAINER_ROXANNE, TRAINER_ROXANNE, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY, TRAINER_BRAWLY, TRAINER_BRAWLY, TRAINER_BRAWLY, TRAINER_BRAWLY, MAP_DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON, TRAINER_WATTSON, TRAINER_WATTSON, TRAINER_WATTSON, TRAINER_WATTSON, MAP_MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY, TRAINER_FLANNERY, TRAINER_FLANNERY, TRAINER_FLANNERY, TRAINER_FLANNERY, MAP_LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN, TRAINER_NORMAN, TRAINER_NORMAN, TRAINER_NORMAN, TRAINER_NORMAN, MAP_PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA, TRAINER_WINONA, TRAINER_WINONA, TRAINER_WINONA, TRAINER_WINONA, MAP_FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA, TRAINER_TATE_AND_LIZA, TRAINER_TATE_AND_LIZA, TRAINER_TATE_AND_LIZA, TRAINER_TATE_AND_LIZA, MAP_MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN, TRAINER_JUAN, TRAINER_JUAN, TRAINER_JUAN, TRAINER_JUAN, MAP_SOOTOPOLIS_CITY),
