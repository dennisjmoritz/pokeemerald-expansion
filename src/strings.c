...
const u8 gText_SideQuestName_2[] = _("Become the POKéMON CHAMPION");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Catch all 386 POKéMON");
const u8 gText_SideQuestDesc_2[] = _("Defeat the ELITE FOUR in all 3 regions");
...
const u8 gText_SideQuestDoneDesc_1[] = _("The POKéDEX is complete!");
const u8 gText_SideQuestDoneDesc_2[] = _("You're the POKéMON CHAMPION!");
...
//map
const u8 gText_SubQuestMapEmpty[] = _("");
const u8 gText_SubQuestMap1[] = _("Pewter City");
const u8 gText_SubQuestMap2[] = _("Cerulean City");
const u8 gText_SubQuestMap3[] = _("Vermilion City");
const u8 gText_SubQuestMap4[] = _("Celadon City");
const u8 gText_SubQuestMap5[] = _("Fuchsia City");
const u8 gText_SubQuestMap6[] = _("Saffron City");
const u8 gText_SubQuestMap7[] = _("Cinnabar Island");
const u8 gText_SubQuestMap8[] = _("Viridian City");
const u8 gText_SubQuestMap9[] = _("Indigo Plateau");
const u8 gText_SubQuestMap10[] = _("Violet City");
const u8 gText_SubQuestMap11[] = _("Azalea Town");
const u8 gText_SubQuestMap12[] = _("Goldenrod City");
const u8 gText_SubQuestMap13[] = _("Ecruteak City");
const u8 gText_SubQuestMap14[] = _("Cianwood City");
const u8 gText_SubQuestMap15[] = _("Olivine City");
const u8 gText_SubQuestMap16[] = _("Mahogany Town");
const u8 gText_SubQuestMap17[] = _("Blackthorn City");
const u8 gText_SubQuestMap18[] = _("Indigo Plateau");
const u8 gText_SubQuestMap19[] = _("Rustboro City");
const u8 gText_SubQuestMap20[] = _("Dewford Town");
const u8 gText_SubQuestMap21[] = _("Mauville City");
const u8 gText_SubQuestMap22[] = _("Lavaridge Town");
const u8 gText_SubQuestMap23[] = _("Petalburg City");
const u8 gText_SubQuestMap24[] = _("Fortree City");
const u8 gText_SubQuestMap25[] = _("Mossdeep City");
const u8 gText_SubQuestMap26[] = _("Sootopolis City");
const u8 gText_SubQuestMap27[] = _("Ever Grande City");
const u8 gText_SubQuestMap28[] = _("Map28");
const u8 gText_SubQuestMap29[] = _("Map29");
const u8 gText_SubQuestMap30[] = _("Map30");

//subquests
const u8 gText_SubQuestEliteFour_Name1[] = _("Pewter City Gym");
const u8 gText_SubQuestEliteFour_Name2[] = _("Cerulean City Gym");
const u8 gText_SubQuestEliteFour_Name3[] = _("Vermilion City Gym");
const u8 gText_SubQuestEliteFour_Name4[] = _("Celadon City Gym");
const u8 gText_SubQuestEliteFour_Name5[] = _("Fuchsia City Gym");
const u8 gText_SubQuestEliteFour_Name6[] = _("Saffron City Gym");
const u8 gText_SubQuestEliteFour_Name7[] = _("Cinnabar Island Gym");
const u8 gText_SubQuestEliteFour_Name8[] = _("Viridian City Gym");
const u8 gText_SubQuestEliteFour_Name9[] = _("Kanto Elite Four");
const u8 gText_SubQuestEliteFour_Name10[] = _("Violet City Gym");
const u8 gText_SubQuestEliteFour_Name11[] = _("Azalea Town Gym");
const u8 gText_SubQuestEliteFour_Name12[] = _("Goldenrod City Gym");
const u8 gText_SubQuestEliteFour_Name13[] = _("Ecruteak City Gym");
const u8 gText_SubQuestEliteFour_Name14[] = _("Cianwood City Gym");
const u8 gText_SubQuestEliteFour_Name15[] = _("Olivine City Gym");
const u8 gText_SubQuestEliteFour_Name16[] = _("Mahogany Town Gym");
const u8 gText_SubQuestEliteFour_Name17[] = _("Blackthorn City Gym");
const u8 gText_SubQuestEliteFour_Name18[] = _("Johto Elite Four");
const u8 gText_SubQuestEliteFour_Name19[] = _("Rustboro City Gym");
const u8 gText_SubQuestEliteFour_Name20[] = _("Dewford Town Gym");
const u8 gText_SubQuestEliteFour_Name21[] = _("Mauville City Gym");
const u8 gText_SubQuestEliteFour_Name22[] = _("Lavaridge Town Gym");
const u8 gText_SubQuestEliteFour_Name23[] = _("Petalburg City Gym");
const u8 gText_SubQuestEliteFour_Name24[] = _("Fortree City Gym");
const u8 gText_SubQuestEliteFour_Name25[] = _("Mossdeep City Gym");
const u8 gText_SubQuestEliteFour_Name26[] = _("Sootopolis City Gym");
const u8 gText_SubQuestEliteFour_Name27[] = _("Hoenn Elite Four");
...
const u8 gText_SubQuestEliteFour_Desc1[] = _("Defeat the Pewter City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc2[] = _("Defeat the Cerulean City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc3[] = _("Defeat the Vermilion City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc4[] = _("Defeat the Celadon City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc5[] = _("Defeat the Fuchsia City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc6[] = _("Defeat the Saffron City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc7[] = _("Defeat the Cinnabar Island Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc8[] = _("Defeat the Viridian City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc9[] = _("Defeat the Kanto region's ELITE FOUR");
const u8 gText_SubQuestEliteFour_Desc10[] = _("Defeat the Violet City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc11[] = _("Defeat the Azalea Town Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc12[] = _("Defeat the Goldenrod City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc13[] = _("Defeat the Ecruteak City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc14[] = _("Defeat the Cianwood City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc15[] = _("Defeat the Olivine City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc16[] = _("Defeat the Mahogany Town Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc17[] = _("Defeat the Blackthorn City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc18[] = _("Defeat the Johto region's ELITE FOUR");
const u8 gText_SubQuestEliteFour_Desc19[] = _("Defeat the Rustboro City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc20[] = _("Defeat the Dewford City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc21[] = _("Defeat the Mauville City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc22[] = _("Defeat the Lavaridge Town Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc23[] = _("Defeat the Petalburg City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc24[] = _("Defeat the Fortree City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc25[] = _("Defeat the Mossdeep City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc26[] = _("Defeat the Sootopolis City Gym and\nobtain the xxx badge");
const u8 gText_SubQuestEliteFour_Desc27[] = _("Defeat the Hoenn region's ELITE FOUR");
