...
const u32 gTrainerFrontPic_AgentSmith[] = INCBIN_U32("graphics/trainers/front_pics/agentsmith.4bpp.smol");
const u16 gTrainerPalette_AgentSmith[] = INCBIN_U16("graphics/trainers/palettes/agentsmith.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_AGENT_SMITH, gTrainerFrontPic_AgentSmith, gTrainerPalette_AgentSmith),
};
