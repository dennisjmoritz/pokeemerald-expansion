...
const u16 gObjectEventPal_Smith[] = INCBIN_U16("graphics/object_events/palettes/agentsmith.gbapal");
...
const u16 gObjectEventPic_OldMan1[] = INCBIN_U16("graphics/object_events/pics/people/old_man_2.4bpp");
